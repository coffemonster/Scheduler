...
public class CopyOfFXMLDocumentController implements Initializable{
	...
	private static CopyOfFXMLDocumentController staticInstance ;
	...
	public static void updateTree(){
			...
			if(Connect.getConnection() != null){
				...
				//emptying TreeView
				CopyOfFXMLDocumentController.getInstance().getTree().getRoot().getChildren().clear();
				try{
					while(result.next()){
						...
						CopyOfFXMLDocumentController.getInstance().getTree().getRoot().getChildren().add(deptTreeItem);
					}
				...
				TreeView<String> tree = CopyOfFXMLDocumentController.getInstance().getTree() ;
	...
	public static CopyOfFXMLDocumentController getInstance(){
